    ...
    <Layout>
      {cartData === "[]" ? (
        <div className="h-[100vh] flex justify-center items-center flex-col gap-4">
          <p className="text-6xl text-center text-gray-600 font-bold">
            Cart is emtpy
          </p>
          <p className="text-3xl text-center text-gray-600 font-bold">
            Please Select the item and add into cart, and then you will see the
            products here!
          </p>
        </div>
      ) : (
        ...
        >
          ...
          <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-">
